...
for instrument_idx in range(16):
    ...
    for velocity in range(100):      # z 방향 (velocity)
        for pitch_idx in range(73):  # x 방향 (pitch)
            ...
            additional_redstone_cmd = f'setblock {x} {y-2} {z} minecraft:chain_command_block[facing=down]{{Command:"setblock {pitch_idx+30} {redstone_y} {redstone_z} minecraft:redstone_block",auto:1b}}'
